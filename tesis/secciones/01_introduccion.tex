...
El tercero es que la alternativa más difundida tampoco resiste el escrutinio. \textcite{slack2020fooling} construyeron una técnica capaz de detectar cuándo una entrada proviene de las perturbaciones que generan LIME y SHAP, y con ella lograron que un clasificador abiertamente discriminatorio no fuera señalado por ninguno de los dos métodos en ninguna instancia de prueba. Antes que ellos, \textcite{lapuschkin2019unmasking} evidenciaron que modelos con un desempeño de estado del arte pueden resolver la tarea mediante atajos espurios; en su estudio, identificaron un clasificador que distinguía una categoría basándose únicamente en una marca de agua presente en las imágenes, sin que las métricas de desempeño estándar detectaran dicha anomalía. De acuerdo con \textcite{mechinterp2025ts}, ``Existing explainability methods often focus on input-output attributions, leaving the internal mechanisms largely opaque''.
...
La contribución que se reclama está en el criterio, no en la extracción. Obtener un grafo desde una matriz es un ejercicio algorítmicamente simple, y varios de los trabajos revisados lo resuelven de una u otra forma. Lo que ninguno reúne es una manera explícita de decidir si ese grafo dice algo del fenómeno o solo del entrenamiento que lo produjo. El framework responde con una lista declarada de propiedades que una relación debe exhibir para sostenerse, verificadas por separado y fijadas antes de ejecutar el procedimiento, y con una taxonomía que separa una relación estructural genuina de un atajo predictivo, de un artefacto de la arquitectura y de ruido estocástico.
