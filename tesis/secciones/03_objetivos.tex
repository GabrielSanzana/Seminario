...
\item Triangular la evidencia mediante cuatro paradigmas ortogonales al enfoque frecuentista ya empleado en el eslabón de consenso estadístico (objetivo específico anterior) --intervencional, geométrico-topológico, de teoría de la información y de baselines deterministas--, que sumados a ese enfoque completan la triangulación de cinco paradigmas declarada en el resumen y la introducción, de modo que la conclusión sobre una arista no dependa de una única familia de supuestos.
