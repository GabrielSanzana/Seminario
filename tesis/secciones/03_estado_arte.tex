...
\textbf{Propuesta} & \multicolumn{3}{p{0.80\linewidth}}{Modelo agnóstico al desplegado, entrenado como alternativa cuando hace falta, con criterio de validación acumulativo, hipótesis nula explícita, contraste entre paradigmas y taxonomía diagnóstica}\\
\bottomrule
\end{longtable}
}
